...
|[**✅1-Branches of Machine Learning**](https://coursesteach.com/mod/page/view.php?id=10612&forceview=1)| [1](https://youtu.be/zBh_F58Yqco?si=vLpTP3fKUJXt2lLp)|---|[1](https://youtu.be/Z-T0iJEXiwM?si=JjXltBnF6gbv2smQ)[-2](https://youtu.be/0MNVhXEX9to?si=ojI9-TpIA2dNgpdc)|
...
|[**✅5-Environment State**](https://coursesteach.com/mod/page/view.php?id=10607)| [1](https://youtu.be/2pWv7GOvuf0?si=m9pjYE00ty3ZdYE6)[-2](https://youtu.be/dGP0_m-zZ4Y?si=hp5Mtp3XF_24SZ2k)|---|----|
...
|[**✅8-RET example**](https://coursesteach.com/mod/page/view.php?id=10609&forceview=1)| [1](https://youtu.be/KQXhPoqx5rU?si=mtEEwIv8KgNOYJun)[-2](https://youtu.be/2pWv7GOvuf0?si=wQw4Q0ZQbB4uAkVv)|---|----|
|[**1- Introduction to Reinforcement Learning**](https://substack.com/home/post/p-155594915)| [1](https://youtu.be/_Y3zdjNPQ7c?si=xpn2sUywk_ATL30U)[-2]([https://youtu.be/2pWv7GOvuf0?si=oWtXhuIefSTMriT0](https://youtu.be/2pWv7GOvuf0?si=tej5mIqXLGW3NR5H))|---|[1](https://youtu.be/Z-T0iJEXiwM?si=JjXltBnF6gbv2smQ)[-2](https://youtu.be/0MNVhXEX9to?si=ojI9-TpIA2dNgpdc)|
...
<details> 
<summary> <h2>Course 04 - 📚Function Approximation </h2> </summary>

## 📚Chapter:3 -**Apps Deployment**
 | Topic Name/Tutorial | Video | Code |
|---|---|---|
|[**🌐1-Linear approximation**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐2-Feature engineering**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐3-Bias–variance tradeoff**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|

</details>

<details> 
<summary> <h2>Course 04 - 📚Deep Reinforcement Learning </h2> </summary>

## 📚Chapter:3 -**Apps Deployment**
 | Topic Name/Tutorial | Video | Code |
|---|---|---|
|[**🌐1-Neural Networks for RL**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐2-DQN (experience replay, target networks)**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐3-Policy Gradient methods**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐4-Actor–Critic (A2C, A3C)**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐5-PPO, DDPG, SAC**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|

</details>

<details> 
<summary> <h2>Course 04 - 📚Advanced RL </h2> </summary>

## 📚Chapter:3 -**Apps Deployment**
 | Topic Name/Tutorial | Video | Code |
|---|---|---|
|[**🌐1-Model-based RL**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐2-Hierarchical RL**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐3-Multi-agent RL**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐4-Offline RL**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐5-Exploration strategies**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|

</details>

<details> 
<summary> <h2>Course 04 - 📚Tools & Frameworks </h2> </summary>

## 📚Chapter:3 -**Apps Deployment**
 | Topic Name/Tutorial | Video | Code |
|---|---|---|
|[**🌐1-Gym / Gymnasium**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐2-Stable-Baselines3**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐3-PyTorch**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
|[**🌐4-Ray RLlib**](https://mushtaqmsit.substack.com/p/how-to-deploy-an-ai-app-locally-step)|---|[![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Machine-Learning/blob/master/Machine_Learning.ipynb)|
...
|-----|------------|-------------|----------------|------------------------|----------|----|
| 1 | [**⭐DeepMind x UCL Introduction to Reinforcement Learning 2015**](https://www.youtube.com/playlist?list=PLqYmG7hTraZDM-OYHWgPebj2MfCFzFObQ) | By  d.silver, Youtube | In Progress | Coursera |--- |[1](https://davidstarsilver.wordpress.com/teaching/)[-2](https://github.com/dalmia/David-Silver-Reinforcement-learning/tree/master)[-3](https://www.amandalmia.com/David-Silver-Reinforcement-learning/)[Slides](https://davidstarsilver.wordpress.com/teaching/)|
